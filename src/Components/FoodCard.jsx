...
const FoodCard = ({ featuredFood }) => {
    const { foodName, imageUrl, pickupLocation, quantity, exp_date, donatorName, donatorImg, additional_notes } = featuredFood;
    return (
            ...
            <div className="card card-compact w-96 lg:w-[450px] bg-base-100 shadow-xl font-Source">
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions items-center">
                        <Link><button className="btn bg-third text-white">View details</button></Link>
