...
import DarkToggol from "./DarkToggol";
            ...
            <div className="navbar-end lg:w-[30%] xl:w-[50%]">
                <DarkToggol></DarkToggol>
                {
                    user ?
                        ...
                        <div>
                            <Link to={'/login'} className="btn bg-third mr-3 text-white">Login</Link>
                            <Link to={'/registration'} className="btn bg-third text-white">Sign Up</Link>
                        </div>
                }
